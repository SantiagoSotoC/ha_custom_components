...
DEFAULT_ARM_OPTIONS = {
    ...
    CONF_NOTIFY_ARM: DEFAULT_NOTIFY_ARM,
    CONF_NOTIFY_DISARM: DEFAULT_NOTIFY_DISARM,
    CONF_NOTIFY_TRIGGER: DEFAULT_NOTIFY_TRIGGER,
}
...
CONF_NOTIFY_ARM = "notify_arm"
CONF_NOTIFY_DISARM = "notify_disarm"
CONF_NOTIFY_TRIGGER = "notify_trigger"

DEFAULT_NOTIFY_ARM = False
DEFAULT_NOTIFY_DISARM = False
DEFAULT_NOTIFY_TRIGGER = True
